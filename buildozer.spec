...
requirements = python3,kivy,https://github.com/kivymd/KivyMD/archive/master.zip,sdl2_ttf==2.0.15,android.permissions,asynckivy,asyncgui,Pillow,requests,urllib3, certifi, openssl, android,charset-normalizer
